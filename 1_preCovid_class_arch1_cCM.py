...
if df is not None:
    ...
    plt.legend()
    plt.grid()
    plt.savefig('preCovid_class_arch1_cCM_accuracy_months.png', dpi=300, bbox_inches='tight')
    plt.show()
    ...
    plt.legend()
    plt.grid()
    plt.savefig('preCovid_class_arch1_cCM_f1score_months.png', dpi=300, bbox_inches='tight')
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig('preCovid_class_arch1_cCM_feature_importance.png', dpi=300, bbox_inches='tight')
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig('preCovid_class_arch1_cCM_heatmap.png', dpi=300, bbox_inches='tight')
    plt.show()
    
    # Salvar os resultados em um arquivo Excel com duas planilhas:
    with pd.ExcelWriter('preCovid_class_arch1_cCM_results.xlsx') as writer:

...
file_path = 'Italia3_corrigido_tratado_Covid.xlsx'
...
if df is not None:
    ...
    plt.legend()
    plt.grid()
    plt.savefig('Covid_class_arch1_cCM_accuracy_months.png', dpi=300, bbox_inches='tight')
    plt.show()
    ...
    plt.legend()
    plt.grid()
    plt.savefig('Covid_class_arch1_cCM_f1score_months.png', dpi=300, bbox_inches='tight')
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig('Covid_class_arch1_cCM_feature_importance.png', dpi=300, bbox_inches='tight')
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig('Covid_class_arch1_cCM_heatmap.png', dpi=300, bbox_inches='tight')
    plt.show()

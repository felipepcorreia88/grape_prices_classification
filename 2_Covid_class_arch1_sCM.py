...
file_path = 'Italia3_nao_corrigido_tratado_Covid.xlsx'
...
if df is not None:
    ...
    plt.legend()
    plt.grid()
    plt.savefig('Covid_class_arch1_sCM_accuracy_months.png', dpi=300, bbox_inches='tight')
    plt.show()
    ...
    plt.legend()
    plt.grid()
    plt.savefig('Covid_class_arch1_sCM_f1score_months.png', dpi=300, bbox_inches='tight')
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig('Covid_class_arch1_sCM_feature_importance.png', dpi=300, bbox_inches='tight')
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig('Covid_class_arch1_sCM_heatmap.png', dpi=300, bbox_inches='tight')
    plt.show()
    
    # Salvar os resultados em um arquivo Excel com duas planilhas:
    with pd.ExcelWriter('Covid_class_arch1_sCM_results.xlsx') as writer:
